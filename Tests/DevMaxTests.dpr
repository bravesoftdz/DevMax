...
uses
  ...
  TestViewItemBasic in 'TestViewItemBasic.pas',
  ...
  TestViewManager in 'TestViewManager.pas',
  ...
  TestManifest in 'TestManifest.pas',
  DevMax.Utils.Binder in '..\Source\Utils\DevMax.Utils.Binder.pas';
